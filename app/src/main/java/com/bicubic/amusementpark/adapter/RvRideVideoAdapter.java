...
public class RvRideVideoAdapter extends RecyclerView.Adapter<RvRideVideoAdapter.ImageHolder> {

    List<RideDetails.VideoBean> videoBeanList;
    Context context;

    public RvRideVideoAdapter(List<RideDetails.VideoBean> videoBeanList, Context context) {
    ...
    public void onBindViewHolder(ImageHolder holder, int position) {
        ...
        Picasso.with(context)
                .load(videoBeanList.get(position).getRideVideo())
                .fit()
